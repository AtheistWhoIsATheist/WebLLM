...
// Set default model to our local Phi-4-mini
...
async function initializeWebLLMEngine() {
  ...
  if (selectedModel === localModel.model_id) {
    config.model_url = localModel.model_url;
  }
...
localOption.textContent = `${localModel.model_id} (Local)`;
document.getElementById("model-selection").appendChild(localOption);
